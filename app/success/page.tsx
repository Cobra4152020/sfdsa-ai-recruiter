...
export default function SuccessPage() {
  ...
  // Prevent scroll reset after component mounts
  useEffect(() => {
  ...
  // Handle direct navigation to awards
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 pt-40 pb-12 bg-[#F8F5EE] dark:bg-[#121212]">
        <div className="container mx-auto px-4">
          <a href="/" onClick={handleHomeClick} className="inline-block mb-8">
              ...
              {action === "apply" ? (
                <div className="mt-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <a href="/#chat-section">
                      <Button className="bg-[#FFD700] hover:bg-[#FFD700]/90 text-[#0A3C1F] dark:text-black font-bold">
          ...
          <div className="max-w-3xl mx-auto mt-16 bg-white dark:bg-[#1E1E1E] rounded-xl shadow-lg p-6 border border-[#E0D6B8] dark:border-[#333333]">
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <a href="/#chat-section" className="inline-block">
                  <Button className="bg-[#FFD700] hover:bg-[#FFD700]/90 text-[#0A3C1F] dark:text-black font-bold">
                    Start Chatting
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
